...
def get_paginator_object(objects_list: List[Any]) -> Paginator:
    """
    This function takes a list of objects and returns a Paginator object with one object
    per page.

    Parameters:
    objects_list (List[Any]): List of objects to paginate.

    Returns:
    Paginator: Paginator object with one object per page.
