  ...
  if (allRichEditors) {
    if (allRichEditors.length > 0) {
      tinymce.init({
        ...
        plugins: "autoresize advlist link lists autosave table anchor directionality insertdatetime link",
        min_height: 400,
        menubar: false,
        // toolbar:
        ...
        toolbar: [
          ...
          { name: "formatting", items: ["bold", "italic", "underline", "strikethrough", "hr"] },
          {
            name: "alignment",
