...
class PermissionHelper:
    ...
    def get_bw_default_permissions(
        ...
        for content_type_item in DEFAULT_PERMISSIONS_NEW_STAFF_MEMBER:
            ...
            # DebuggingPrint.pprint(permissions_codename_labels)
            # DebuggingPrint.pprint(content_type_item)
            # DebuggingPrint.pprint(extra_permissions)
            ...
            for codename, extra_codename in itertools.zip_longest(
                ...
                # DebuggingPrint.pprint(codename)
                # DebuggingPrint.pprint(extra_codename)
                if extra_codename:
