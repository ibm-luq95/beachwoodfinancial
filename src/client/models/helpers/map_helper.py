...
from client.models.querysets.types import JobItemDictType, TYPED_ALL_ITEM
from core.utils import bw_log, get_months_abbr, debugging_print
                    ...
                    for month_idx, jobs_details in tmp_month_data.items():
                        ...
                        for tmp_job_item in jobs_details:
                            ...
                            if tmp_job_item.get("job_month") in merged_dict.keys():
                                merged_dict[tmp_job_item.get("job_month")]["id"] = (
                                    tmp_job_item.get("id")
                                )
                                merged_dict[tmp_job_item.get("job_month")]["job_month"] = (
